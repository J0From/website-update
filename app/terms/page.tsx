        ...
        <div className="prose prose-slate max-w-none">
          ...
          <section className="mb-12">
            ...
            <p className="text-slate-700 leading-relaxed mb-4">
              ...
              with third-party applications, and optimize operations through Human + Machine solutions. Our Services include:
            </p>
            <ul className="list-disc pl-6 space-y-2 text-slate-700">
              <li>Human + Machine workflow management</li>
              <li>Integration with third-party business applications</li>
              <li>Custom Jo from configuration and deployment</li>
          ...
          <section className="mb-12">
            ...
            <p className="text-slate-700 leading-relaxed">
              ...
              platform models and Services. We will never sell your personal data to third parties.
            </p>
          </section>
