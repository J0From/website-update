...
export const metadata: Metadata = {
  ...
  description:
    "Discover Jo's intelligent collaboration solutions for SMBs, enterprises, and consultants. Choose the right digital workforce for your business size and industry needs.",
  openGraph: {
    title: "Solutions for Every Business | Jo: Human + Machine",
    description:
      "Discover Jo's intelligent collaboration solutions for SMBs, enterprises, and consultants. Choose the right digital workforce for your business size and industry needs.",
