          ...
          <div className="grid md:grid-cols-2 gap-12 items-center mb-12">
            <div className="text-center md:text-left">
              ...
              <p className="text-xl text-gray-600 mb-8">
                {activeTab === "growth"
                  ? "Helping businesses scale with real People & Machine Collaboration"
            ...
            <div>
              <div className="mb-16">
                ...
                <p className="text-xl text-gray-600 text-center max-w-3xl mx-auto mb-12">
                  Our fractional Growth team manages your business development, empowered by Jo's capabilities, so you can lead
                </p>
          ...
          {activeTab === "operations" && (
            <div>
              <div className="mb-16">
                ...
                <p className="text-xl text-gray-600 text-center max-w-3xl mx-auto mb-12">
                  Our fractional Operations team manages your backend, empowered by Jo's capabilities, so you can lead
                </p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-8">
                  ...
                  <Card className="border-2 hover:border-purple-200 transition-all">
                    <CardContent className="p-8 text-center">
                      ...
                      <p className="text-gray-600 text-sm">We design and implement operations collaboration.</p>
                    </CardContent>
                  </Card>
