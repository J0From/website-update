...
export default function SmallBusinessPage() {
  ...
  const businessSizes = [
    ...
    },
    {
      ...
      features: ["Up to 5 Jo's", "Advanced capabilities", "Priority support", "Custom workflows"],
      price: "$125/mo",
      highlighted: true,
      badge: "Most Popular",
    },
  ...
  const howItWorksSteps = [
    ...
    },
    {
      number: "02",
      title: "Activate",
      description: "Choose which Jo team members you need and set your preferences",
      icon: CheckCircle2,
    },
    {
      number: "03",
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto text-pretty">
              Every Jo is an expert in their domain, working together seamlessly
            </p>
          </div>
