  ...
  const departmentFeatures = [
    ...
    },
    {
      ...
      features: [
        ...
        "Employee performance review coordination",
    ...
    },
    {
      ...
      features: [
        ...
        "Streamlined invoice generation and tracking",
    ...
    },
    {
      ...
      features: [
        ...
        "Streamlined backup and recovery systems",
      ],
    },
    {
      name: "Support",
      ...
      features: [
        ...
        "Streamlined ticket routing and prioritization",
    ...
    },
    {
      ...
      features: [
        ...
        "Streamlined follow-up reminders",
                    ...
                    <div>
                      ...
                      <div className="space-y-3">
                        ...
                        <div className="text-center">
                          ...
                          <div className="text-sm text-gray-600">Lead management & follow-up streamlining</div>
                        </div>
                        <div className="text-center">
                  ...
                  <div className="space-y-4 mb-8 flex-grow">
                    ...
                    <div>
                      ...
                      <div className="space-y-3">
                        ...
                        <div className="text-center">
                          <div className="text-sm font-semibold text-gray-900">HR</div>
                          <div className="text-sm text-gray-600">Rapid scaling & talent acquisition streamlining</div>
                        </div>
                        <div className="text-center">
                          <div className="text-sm font-semibold text-gray-900">Sales</div>
                  ...
                  <div className="space-y-4 mb-8 flex-grow">
                    <div className="bg-slate-50 rounded-lg p-4">
                      ...
                      <ul className="text-sm text-gray-700 space-y-1">
                        ...
                        <li>Process streamlining across portfolio</li>
                    ...
                    <div>
                      ...
                      <div className="space-y-3">
                        <div className="text-center">
                          <div className="text-sm font-semibold text-gray-900">Operations</div>
                          <div className="text-sm text-gray-600">Process optimization & cost reduction streamlining</div>
                        </div>
                        <div className="text-center">
                          <div className="text-sm font-semibold text-gray-900">Finance</div>
                        ...
                        <div className="text-center">
                          <div className="text-sm font-semibold text-gray-900">Accounting</div>
                          <div className="text-sm text-gray-600">Financial consolidation & reporting streamlining</div>
                        </div>
                        <div className="text-center">
                          <div className="text-sm font-semibold text-gray-900">IT</div>
            ...
            <Card className="p-4 sm:p-6 border-2 hover:border-blue-600 transition-colors">
              <CardContent className="p-0">
                ...
                <p className="text-xs sm:text-sm text-gray-600 leading-relaxed">
                  Consolidate multiple apps into one unified platform.
                </p>
              </CardContent>
            </Card>
