...
export const metadata: Metadata = {
  ...
  description: "Scale your operations with intelligent collaboration built for growing companies",
}
  ...
  const capabilities = [
    {
      ...
      description: "Connect Finance, HR, Operations, and Sales with streamlined handoffs and shared data flows",
    },
    {
      icon: BarChart3,
    ...
    {
      icon: Settings,
      title: "Custom Jo Configuration",
      description: "Tailor each Jo's behavior to match your unique processes and compliance requirements",
    },
    {
      icon: Headphones,
