  ...
  const enterpriseFeatures = [
    ...
    },
    {
      ...
      features: [
        ...
        "Proposal generation with approval workflows",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="max-w-3xl mx-auto text-center mb-12">
          ...
          <p className="text-lg text-gray-600">
            Jo enables seamless Human + Machine workflows across every department, where machine capabilities handle structured
