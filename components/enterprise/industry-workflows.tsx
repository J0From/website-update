        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 border-2 border-slate-200 hover:border-blue-400 group">
            ...
            <p className="text-sm text-slate-600 text-center leading-relaxed">
              Continuous generation of regulatory filings, audit documentation, and compliance reports
            </p>
          </div>
          ...
          <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 border-2 border-slate-200 hover:border-blue-400 group">
            ...
            <p className="text-sm text-slate-600 text-center leading-relaxed">
              Machine-driven data classification, retention policies, and privacy controls
            </p>
          </div>
          ...
          <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 border-2 border-slate-200 hover:border-blue-400 group">
            ...
            <p className="text-sm text-slate-600 text-center leading-relaxed">
              Continuous monitoring, risk assessment, and proactive incident response
            </p>
          </div>
