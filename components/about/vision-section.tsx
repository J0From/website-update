  ...
  return (
    <section className="py-16 sm:py-20 bg-gray-50">
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
              ...
              <p className="text-gray-700 leading-relaxed">
                ...
                employees as a trusted teammate, handling repetitive tasks so people can focus on what people do best.
              </p>
            </div>
            <div>
              <h4 className="font-bold text-gray-900 mb-2 text-lg">2. Specialization Through Depth</h4>
              <p className="text-gray-700 leading-relaxed">
                We reject one-size-fits-all solutions. Every Jo from department possesses deep domain expertise
        ...
        <div>
          <h3 className="text-3xl font-bold text-gray-900 mb-10 text-center">Jo from Every Department</h3>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {departments.map((dept) => (
              <Card key={dept.name} className="hover:shadow-lg transition-shadow border-2 hover:border-blue-200">
                <CardContent className="p-6 flex flex-col items-center">
                  <div className="text-5xl mb-3 mx-auto">{dept.icon}</div>
                  <h4 className="font-bold text-gray-900 mb-1 text-sm text-center">{dept.name}</h4>
                  <p className="text-xs text-gray-600 text-center">{dept.description}</p>
                </CardContent>
              </Card>
            ))}
          </div>
